    ...
    <header class="bg-dark py-5">
        ...
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">TIP - Reservation Homepage</h1>
                <p class="lead fw-normal text-white-50 mb-0">Welcome to the Reservation Homepage</p>
            </div>
        </div>
    </header>
    <?php
...
if ($result->num_rows > 0) {
  echo "<div class='row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center'>"; // Use Bootstrap grid classes
