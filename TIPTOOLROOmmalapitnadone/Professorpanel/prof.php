                ...
                success: function (data) {
                    ...
                    if (data.error) {
                        ...
                        const transactionHTML = Object.values(transactionsByStudentAndCourse).map(function (studentCourseGroup) {
                            ...
                            const studentID = studentCourseGroup.studentID; // Include studentID
                            ...
                            return `
                                <li>Student: ${studentName} - Course: ${course} - Student ID: ${studentID} - Date: ${formattedDate}<br>${itemsHTML}<br>${confirmButton}<br>${rejectAllButton}</li>
                            `;
                        }).join('');
...
$(document).on('click', '.confirmAllButton', function () {
    ...
    // Remove the transactions from display
    removeTransactionsFromDisplay(studentName, course);
